        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="bg-green-600 px-8 py-10 text-center">
              ...
              <p className="text-green-100 text-sm mt-1">Greenhouse Management System</p>
            </div>
            <div className="p-8 space-y-5">
              <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700 mt-1">
                    Supabase is not configured. The app is running with static demo data.
              ...
              <p className="text-center text-xs text-gray-400">
                Connect Supabase to enable full functionality
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2.5 pr-11 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  placeholder="••••••••"
                />
                <button
                  type="button"
        ...
        <p className="text-center text-xs text-gray-400 mt-4">
          GreenCrop v1.0 · Authorized access only
        </p>
      </div>
    </div>
  )
